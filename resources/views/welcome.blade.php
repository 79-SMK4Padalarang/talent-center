    ...
    <div class="absolute bottom-60 w-full pb-32">
      ...
      <dialog id="my_modal_2" class="modal rounded-lg z-50">
        <div class="modal-box">
          ...
          @endif
          <form name="registerForm" id="registerForm" method="dialog" class="button center">
          @csrf
          {{ csrf_field() }}
            <div class="flex justify-center bg-white p-5">
              <div class="relative"">
                <div class="unit">
                  <div class="unit-a">
                    <div class="unit-b">
                      <button class="popup-close absolute right-2.5 top-2 ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900">
                          ...
                          <div class="form-1">
                              ...
                              <div class="pw-again">
                                  <div class="password-validate">
                                      <div class="form-7">
                                          <div class="form-6">
                                              <i id="icon1" class="fa-solid fa-times fa-sm invalid" style="position: relative; left: 1px; top: 4px;"></i>
                                          </div>
                                      </div>
                                      <div id="length" style="position: relative; left: 0px; top: 6px;" class="checkbox invalid">Password is at least 8 characters long</div>
                                  </div>
                                  <div class="password-validate">
                                      <div class="form-4">
                                          <div class="form-5">
                          ...
                          <div class="gender-b">
                              <div class="gender-a">
                                  ...
                                  <div class="bch">
                                          ...
                                          <div style="color: #848484; font-size: 14px; font-family: Inter; font-weight: 400; word-wrap: break-word; padding-top: -10px">Male</div>
                                      </div>
                                      <div class="bch">
                                          <div class="bch-a">
                                              <input class="bch-b" type="radio" name="gender" value="female">
                                          </div>
                                          <div style="color: #848484; font-size: 14px; font-family: Inter; font-weight: 400; word-wrap: break-word; padding-top: -10px;">Female</div>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="back-box">
                            <input type="date" id="birth_date" name="birth_date" value="{{ old('birth_date') }}" class="box" placeholder="Date of birth" required="required">
                              <script>
                              ...
                              <div style="width: 15px; height: 14px; position: absolute; left: 428px; top: 509px;">
                                  <div style="">
                  ...
                  <div class="bg-button">
                    ...
                    <div style="align-self: center; width: 445px; height: 40px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 15px; display: flex">
                      <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 10px; display: inline-flex">
                          <a style="flex: 1 1 0; height: 45px; padding-left: 20px; padding-right: 20px; padding-top: 7px; padding-bottom: 7px; border-radius: 5px; overflow: hidden; border: 1px #848484 solid; justify-content: center; align-items: center; gap: 7px; display: flex">
